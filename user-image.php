        ...
        <h2 >Account Picture</h2>
			...
			<?php
				if(isset($_GET["op"]))
				{
					...
					{
			?>
						<form action="user-image-controller.php?op=add" method="post" enctype="multipart/form-data">
						<div class="block clear">
						<label for="comment"><h3>Choose image</h3> </label>
						<input type="file" name="uImage" id="uImage" value="" size="100" style="border:solid #898989 2px;">
						</div>
						<input type="submit" name="add" value="Add pic" style="background-color:#898989; color:white;">
						</div>
						</form>
			<?php 
					}
					...
					{
				?>
						<form action="user-image-controller.php?op=update" method="post" enctype="multipart/form-data">
						<div class="block clear">
						<label for="comment"><h3>Choose image</h3> </label>
						<input type="file" name="uImage" id="uImage" value="" size="100" style="border:solid #898989 2px;">
						</div>
						<input type="submit" name="update" value="Change Pic" style="background-color:#898989; color:white;">
						</div>
						</form>
				<?php
					}
				...
				?>
					<form action="#" method="post" enctype="multipart/form-data">
						<div class="block clear">
						<label for="comment"><h3>Choose image</h3> </label>
						<input type="file" name="Image" id="Image" value="" size="100" style="border:solid #898989 2px;">
						</div>
						<input type="submit" name="update" value="Change Pic" style="background-color:#898989; color:white;">
						</div>
						</form>
